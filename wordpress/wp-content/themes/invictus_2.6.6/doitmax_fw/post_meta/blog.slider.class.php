	...
	public function getMetaBox() {
		...
		$this->addGroupOpen(array(
			...
			$this->createMetabox(array(
				...
				'title' => __('Image Settings', MAX_SHORTNAME),
				'priority' => "high"
			));
				...
				$this->addDropdown(array(
					...
					'label' => __('Slider or Images?', MAX_SHORTNAME),
					"options" => array('none'=>"Show Featured Image", 'slider-nivo' => 'Nivo Slider', 'slider-slides' => 'Slides Slider', 'slider-kwicks' => 'Accordion Slider'  ),
					"standard" => "none",
					"display" => true,
			...
			// Disable Lightbox
			$this->addDropdown(array(
				'id' => MAX_SHORTNAME.'_photo_lightbox',
				'label' => __('Disable lightbox', MAX_SHORTNAME),
				"options" => array('false' => "No", 'true' => "Yes"),
				"standard" => "false",
				"display" => true,
				"desc" => __('Choose if you want to deactivate the lightbox for this photo post on the details page.', MAX_SHORTNAME )
			));
