		...
		$this->addGroupOpen(array(
			...
			$this->addGroupOpen(array(
				...
				$this->addInput(array(
					...
					"size" => "480",
					"desc" => __('You can enter a custom URL to link to when you click on the post title in the full size gallery view of this photo. Leave blank to link to the photo post detail page. Remember to add a http:// in front of your URL.', MAX_SHORTNAME)
				));
