		...
		if(!in_array($family, $_temp_fonts)){
			...
			switch($family) {
				...
				default:
					...
					wp_register_style('googleFonts_'.preg_replace('/\s+/', '_', $family), 'http://fonts.googleapis.com/css?family='.$google_font_array[$family].$subset);
...
function max_dashboard_custom_feed_output() {
     ...
     wp_widget_rss_output(array(
          'url' => 'http://themes.doitmax.de/wordpress/invictus/feed/',
