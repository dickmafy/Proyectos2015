...
global $showSuperbgimage, $fromGallery, $taxonomy_name, $the_term, $post_terms, $isFullsizeGallery, $isPost, $isBlog, $shortname, $main_homepage, $_query_has_videos, $isFullsizeFlickr, $infiniteScroll;
