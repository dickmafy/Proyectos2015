	...
	function max_options(){
		...
		$options[] = array( "name" => __('Logo options', MAX_SHORTNAME),
			...
			$options[] = array( "name" => __('Logo Retina @2x', MAX_SHORTNAME),
								"desc"  => __('Please choose an image file for the retina version of the logo. This logo must be twice as large as the original. E.g. original logo is 100x50px => Retina hast to be 200x100px', MAX_SHORTNAME),
		...
		$options[] = array( "name" => __('Other settings', MAX_SHORTNAME),
			...
			$options[] = array( "name" => __('Always show lightbox link', MAX_SHORTNAME),
								"desc" => __('Always show the lightbox link even thought it is set to link to the project page.', MAX_SHORTNAME),
		...
		$options[] = array( "name" => __('Slider Settings', MAX_SHORTNAME),
			...
			$options[] = array( "name" => __('Show more link beside full size title', MAX_SHORTNAME),
								"desc" => __('Check, if you want to show a "more" arrow beside the full size title.', MAX_SHORTNAME),
...
function rss_filter_password_where($where) {
