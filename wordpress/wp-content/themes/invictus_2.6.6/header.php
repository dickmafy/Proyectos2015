...
if( !is_plugin_active('wordpress-seo/wp-seo.php') ){
  ...
  <?php if( get_the_excerpt() != "" ){ ?>
  	<meta property="description" content='<?php echo strip_tags(get_the_excerpt()) ?>' />
  <?php }else{ ?>
  	<meta property="description" content='<?php echo get_bloginfo( 'description', 'display' ) ?>' />
  <?php } ?>

  	<!-- Google will often use this as its description of your page/site. Make it good. -->
  <?php if( get_the_excerpt() != "" ){ ?>
  	<meta property="google-site-verification" content='<?php echo strip_tags(get_the_excerpt()) ?>' />
  <?php }else{ ?>
  	<meta property="google-site-verification" content='<?php echo get_bloginfo( 'description', 'display' ) ?>' />
  <?php } ?>
  ...
  <?php else :  // get facebook og meta for frontpage
...
<body <?php body_class(array($fit_images, $blog_class, get_option_max('color_main',false).'-theme', $fixed_logo)); ?>>
...
<div id="page">
	...
	<?php
	$logo_width = get_option_max('custom_logo_width_value');
	$logo_height = get_option_max('custom_logo_height_value');
	$logo_url_2x = get_option_max('custom_logo_2x_value');
	?>
		...
		<hgroup class="navbar">
			<h1 id="site-title" class="clearfix">
				<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" class="logo">
					<img src="<?php echo $logo_url ?>" alt="<?php bloginfo( 'name' ); ?> - <?php bloginfo( 'description' ); ?>" width="<?php echo $logo_width ?>" height="<?php echo $logo_height ?>" />
