...
function paginacion_usuario($total, $tamanopagina)
{
  ...
  {
	if($nropag==$i){
	echo("<a href='administrar.php?nropag=".$pagina."' class='vinculorojo'>".$pagina."</a>&nbsp&nbsp");
	}else{
	echo("<a href='administrar.php?nropag=".$pagina."' class='vinculo'>".$pagina."</a>&nbsp&nbsp");
	}
	$pagina++;
  }	
}

function paginacion_trabajador($total, $tamanopagina)
{
  $totalpag = ceil($total/$tamanopagina);
  $pagina = 1;
  $nropag = $_GET["nropag"];
...
function paginacion_destacado($total, $tamanopagina)
{
  $totalpag = ceil($total/$tamanopagina);
  $pagina = 1;
  $nropag = $_GET["nropag"];
...
function paginacion_empleador($total, $tamanopagina)
{
  $totalpag = ceil($total/$tamanopagina);
  $pagina = 1;
  $nropag = $_GET["nropag"];
...
function paginacion_precontrato($total, $tamanopagina, $idempleador)
{
  $totalpag = ceil($total/$tamanopagina);
  $pagina = 1;
  $nropag = $_GET["nropag"];
  ...
  {
	if($nropag==$i){
	echo("<a href='registro.php?nropag=".$pagina."&idempleador=".$idempleador."' class='vinculorojo'>".$pagina."</a>&nbsp&nbsp");
	}else{
	echo("<a href='registro.php?nropag=".$pagina."&idempleador=".$idempleador."' class='vinculo'>".$pagina."</a>&nbsp&nbsp");
	}
	$pagina++;
  }	
}

function paginacion_contrato($total, $tamanopagina)
{
  $totalpag = ceil($total/$tamanopagina);
  $pagina = 1;
  $nropag = $_GET["nropag"];
...
function paginacion_comprobante($total, $tamanopagina)
{
  $totalpag = ceil($total/$tamanopagina);
  $pagina = 1;
  $nropag = $_GET["nropag"];
