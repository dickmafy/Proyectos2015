...
function  getDiasPorMesFechaInicio(){
        ...
        function  getDiasPorMesFechaFin(){
            ...
            console.log("DIAS TOTALES FECHA FINAL : " + diasDelMes );
 ...
 function validarFechaMayorMenor()
       ...
       console.log("FECHA FINAL " + fechaFinal);
        ...
        function calcular_liquidacion() {
            cts = parseFloat(document.getElementById('cts').value);
            vacaciones = parseFloat(document.getElementById('vacaciones').value);
            gratificacion = parseFloat(document.getElementById('gratificacion').value);
            monto = parseFloat(document.getElementById('monto').value);
            console.log("###############LIQUIDACION###########");
            console.log("liquidacion > cts " +cts);
            console.log("liquidacion > vacaciones " +vacaciones);
            console.log("liquidacion > gratificacion " +gratificacion);
            console.log("liquidacion > monto " +monto);
            liquid = (cts + vacaciones + gratificacion + monto);
            document.getElementById('liquidacion').value = liquid.toFixed(2);
