...
<table height="203" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <?php
	  ...
	  if($_POST["capacitacion"]!=""){$capacitacion = $_POST["capacitacion"];}else{$capacitacion = $arr_datos[42];} 
	  if($_POST["documento1"]!=""){$documento1 = $_POST["documento1"];}else{$documento1 = $arr_datos[43];} 
	  if($_POST["documento2"]!=""){$documento2 = $_POST["documento2"];}else{$documento2 = $arr_datos[44];} 
	  if($_POST["documento3"]!=""){$documento3 = $_POST["documento3"];}else{$documento3 = $arr_datos[45];} 
	  if($_POST["tipo_doc4"]!=""){$tipo_doc4 = $_POST["tipo_doc4"];}else{$tipo_doc4 = $arr_datos[46];} 
	  if($_POST["documento4"]!=""){$documento4 = $_POST["documento4"];}else{$documento4 = $arr_datos[47];} 
	  if($_POST["documento5"]!=""){$documento5 = $_POST["documento5"];}else{$documento5 = $arr_datos[48];} 
	  if($_POST["nombre_ref1"]!=""){$nombre_ref1 = $_POST["nombre_ref1"];}else{$nombre_ref1 = $arr_datos[49];}	
	  if($_POST["tipo_doc_ref1"]!=""){$tipo_doc_ref1 = $_POST["tipo_doc_ref1"];}else{$tipo_doc_ref1 = $arr_datos[50];}  
	  if($_POST["num_doc_ref1"]!=""){$num_doc_ref1 = $_POST["num_doc_ref1"];}else{$num_doc_ref1 = $arr_datos[51];} 
	  if($_POST["direccion_ref1"]!=""){$direccion_ref1 = $_POST["direccion_ref1"];}else{$direccion_ref1 = $arr_datos[52];} 
	  if($_POST["tipo_ref1"]!=""){$tipo_ref1 = $_POST["tipo_ref1"];}else{$tipo_ref1 = $arr_datos[53];}  
	  if($_POST["act_ref1"]!=""){$act_ref1 = $_POST["act_ref1"];}else{$act_ref1 = $arr_datos[54];}
	  if($_POST["fechaini_ref1"]!=""){$fechaini_ref1 = $_POST["fechaini_ref1"];}else{$fechaini_ref1 = $arr_datos[55];} 
	  if($_POST["fechafin_ref1"]!=""){$fechafin_ref1 = $_POST["fechafin_ref1"];}else{$fechafin_ref1 = $arr_datos[56];} 
	  if($_POST["retiro_ref1"]!=""){$retiro_ref1 = $_POST["retiro_ref1"];}else{$retiro_ref1 = $arr_datos[57];} 
	  if($_POST["telefono_ref1"]!=""){$telefono_ref1 = $_POST["telefono_ref1"];}else{$telefono_ref1 = $arr_datos[58];}  
	  if($_POST["nombre_ref2"]!=""){$nombre_ref2 = $_POST["nombre_ref2"];}else{$nombre_ref2 = $arr_datos[59];} 
	  if($_POST["tipo_doc_ref2"]!=""){$tipo_doc_ref2 = $_POST["tipo_doc_ref2"];}else{$tipo_doc_ref2 = $arr_datos[60];} 
	  if($_POST["num_doc_ref2"]!=""){$num_doc_ref2 = $_POST["num_doc_ref2"];}else{$num_doc_ref2 = $arr_datos[61];} 
	  if($_POST["direccion_ref2"]!=""){$direccion_ref2 = $_POST["direccion_ref2"];}else{$direccion_ref2 = $arr_datos[62];} 
	  if($_POST["tipo_ref2"]!=""){$tipo_ref2 = $_POST["tipo_ref2"];}else{$tipo_ref2 = $arr_datos[63];} 
	  if($_POST["act_ref2"]!=""){$act_ref2 = $_POST["act_ref2"];}else{$act_ref2 = $arr_datos[64];} 
	  if($_POST["fechaini_ref2"]!=""){$fechaini_ref2 = $_POST["fechaini_ref2"];}else{$fechaini_ref2 = $arr_datos[65];} 
	  if($_POST["fechafin_ref2"]!=""){$fechafin_ref2 = $_POST["fechafin_ref2"];}else{$fechafin_ref2 = $arr_datos[66];} 
	  if($_POST["retiro_ref2"]!=""){$retiro_ref2 = $_POST["retiro_ref2"];}else{$retiro_ref2 = $arr_datos[67];}  
	  if($_POST["telefono_ref2"]!=""){$telefono_ref2 = $_POST["telefono_ref2"];}else{$telefono_ref2 = $arr_datos[68];} 
	  ?>
     <table width="90%" height="86" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="694" height="86" align="left" valign="top">
        ...
        <table width="685" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="685" height="39" align="left" valign="middle" class="texto">
            <strong class="textoverde">DÍA DE DESCANSO</strong>
            </td>
          </tr>
          <tr>
            <td height="20" align="left" valign="middle" class="texto">
