...
registrar_empleador($ape_paterno, $ape_materno, $nombres, $tipo_doc, $nro_doc, $estado_civil, $sexo, 
				    $fecha_nac, $hijos, $nro_hijos, $mascota, $idpais, $tipo, $nombre, $dpto, 
				    $manzana, $lote, $urbanizacion, $referencia, $iddepartamento, $idprovincia, 
				    $iddistrito, $telefono, $tipo_cel, $celular, $adultos, $desc_adultos, $ninos, 
				    $desc_ninos, $mascotas, $desc_mascotas, $email, $se_entero);
