      ...
      <td width="694" height="86" align="left" valign="top">
        ...
        <table width="685" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			echo(strtoupper($direccion)." - ".strtoupper($nomdistrito))."<br>";
			if($urbanizacion!="" && $urbanizacion!="Urbanizacion")
			{echo(strtoupper("URB. ".$urbanizacion)."&nbsp;&nbsp;&nbsp;&nbsp;");}
			if($referencia!="" && $referencia!="Referencia"){echo(strtoupper("REF. ".$referencia));}
			?>
            </td>
          </tr>
        </table>
        ...
        <table width="688" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="25" align="left" valign="top" class="texto">
            <?php if($tipo_ref1==""){echo(strtoupper("-"));}?>
            <?php if($tipo_ref1=="0"){echo(strtoupper("Cama afuera"));}?>
            <?php if($tipo_ref1=="1"){echo(strtoupper("Cama adentro"));}?>
            <?php if($tipo_ref1=="2"){echo(strtoupper("Por horas"));}?>
            &nbsp;&nbsp;
            ...
            <td height="25" align="left" valign="top" class="texto">
            <?php if($tipo_ref2==""){echo(strtoupper("-"));}?>
            <?php if($tipo_ref2=="0"){echo(strtoupper("Cama afuera"));}?>
            <?php if($tipo_ref2=="1"){echo(strtoupper("Cama adentro"));}?>
            <?php if($tipo_ref2=="2"){echo(strtoupper("Por horas"));}?>
            &nbsp;&nbsp;
