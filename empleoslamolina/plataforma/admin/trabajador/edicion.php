...
<table width="100%" height="91" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <form id="form" name="form" method="post" action="proc_actualizar_trabajador.php" enctype="multipart/form-data">
	  ...
	  if($_POST["nprovincia"]!=""){$nprovincia = $_POST["nprovincia"];}else{$nprovincia = $arr_datos[74];}
	  if($_POST["email"]!=""){$email = $_POST["email"];}else{$email = $arr_datos[75];}
	  if($_POST["destacado"]!=""){$destacado = $_POST["destacado"];}else{$destacado = $arr_datos[76];} 
	  ?>
      ...
      <table width="685" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td height="20" colspan="2" align="left" valign="middle" class="cajatextooscuro">
...
function validar()
{
 ...
 if(form.ape_paterno.value=="" || form.ape_materno.value=="" || form.nombres.value=="" || form.tipo_doc.value=="" 
	...
	|| form.descanso.value=="" || form.nprovincia.value=="")  
 {
