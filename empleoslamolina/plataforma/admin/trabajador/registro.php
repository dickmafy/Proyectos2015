...
<table width="100%" height="91" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1195" align="right" valign="middle" class="negrita14">Registrar Trabajador</td>
  ...
  <tr>
    ...
    <table width="554" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <span class="texto">En esta sección podrás registrar un nuevo trabajador en el 
        sistema</span>
        </td>
        </tr>
    </table>
  ...
  <tr>
    ...
    <form id="form" name="form" method="post" action="proc_registrar_trabajador.php" enctype="multipart/form-data">
      <div class="container">
      <ul class="tabs">
	  ...
	  if($_POST["instruccion"]!=""){$instruccion = $_POST["instruccion"];}  
	  ...
	  if($_POST["cama_afuera"]!=""){$cama_afuera = $_POST["cama_afuera"];}						
	  if($_POST["cama_adentro"]!=""){$cama_adentro = $_POST["cama_adentro"];}
	  if($_POST["horas"]!=""){$horas = $_POST["horas"];}
	  if($_POST["cocina"]!=""){$cocina = $_POST["cocina"];}
	  if($_POST["limpieza"]!=""){$limpieza = $_POST["limpieza"];} 
	  if($_POST["ninera"]!=""){$ninera = $_POST["ninera"];} 
	  if($_POST["enfermeria"]!=""){$enfermeria = $_POST["enfermeria"];} 
	  if($_POST["mayordomo"]!=""){$mayordomo = $_POST["mayordomo"];} 
	  if($_POST["chofer"]!=""){$chofer = $_POST["chofer"];}
	  if($_POST["todo_servicio"]!=""){$todo_servicio = $_POST["todo_servicio"];} 
	  if($_POST["sueldo"]!=""){$sueldo = $_POST["sueldo"];} 
	  if($_POST["descanso"]!=""){$descanso = $_POST["descanso"];} 
	  if($_POST["tipo_estudio"]!=""){$tipo_estudio = $_POST["tipo_estudio"];} 
	  if($_POST["descripcion"]!=""){$descripcion = $_POST["descripcion"];}
	  if($_POST["empresa"]!=""){$empresa = $_POST["empresa"];}
	  if($_POST["cargo"]!=""){$cargo = $_POST["cargo"];} 
	  if($_POST["ama_casa"]!=""){$ama_casa = $_POST["ama_casa"];}
	  if($_POST["se_entero"]!=""){$se_entero = $_POST["se_entero"];} 
	  if($_POST["capacitacion1"]!=""){$capacitacion1 = $_POST["capacitacion1"];}
	  if($_POST["capacitacion2"]!=""){$capacitacion2 = $_POST["capacitacion2"];}
	  if($_POST["capacitacion3"]!=""){$capacitacion3 = $_POST["capacitacion3"];}
	  if($_POST["capacitacion4"]!=""){$capacitacion4 = $_POST["capacitacion4"];} 
	  if($_POST["documento1"]!=""){$documento1 = $_POST["documento1"];}
	  if($_POST["documento2"]!=""){$documento2 = $_POST["documento2"];} 
	  if($_POST["documento3"]!=""){$documento3 = $_POST["documento3"];} 
	  if($_POST["tipo_doc4"]!=""){$tipo_doc4 = $_POST["tipo_doc4"];}
	  if($_POST["documento4"]!=""){$documento4 = $_POST["documento4"];} 
	  if($_POST["documento5"]!=""){$documento5 = $_POST["documento5"];}
	  if($_POST["documento6"]!=""){$documento6 = $_POST["documento6"];}
	  if($_POST["documento7"]!=""){$documento7 = $_POST["documento7"];} 
	  if($_POST["nombre_ref1"]!=""){$nombre_ref1 = $_POST["nombre_ref1"];}	
	  if($_POST["tipo_doc_ref1"]!=""){$tipo_doc_ref1 = $_POST["tipo_doc_ref1"];}  
	  if($_POST["num_doc_ref1"]!=""){$num_doc_ref1 = $_POST["num_doc_ref1"];}
	  if($_POST["direccion_ref1"]!=""){$direccion_ref1 = $_POST["direccion_ref1"];} 
	  if($_POST["tipo_ref1"]!=""){$tipo_ref1 = $_POST["tipo_ref1"];}  
	  if($_POST["act_ref1"]!=""){$act_ref1 = $_POST["act_ref1"];}
	  if($_POST["fechaini_ref1"]!=""){$fechaini_ref1 = $_POST["fechaini_ref1"];} 
	  if($_POST["fechafin_ref1"]!=""){$fechafin_ref1 = $_POST["fechafin_ref1"];} 
	  if($_POST["retiro_ref1"]!=""){$retiro_ref1 = $_POST["retiro_ref1"];}
	  if($_POST["telefono_ref1"]!=""){$telefono_ref1 = $_POST["telefono_ref1"];}  
	  if($_POST["nombre_ref2"]!=""){$nombre_ref2 = $_POST["nombre_ref2"];} 
	  if($_POST["tipo_doc_ref2"]!=""){$tipo_doc_ref2 = $_POST["tipo_doc_ref2"];} 
	  if($_POST["num_doc_ref2"]!=""){$num_doc_ref2 = $_POST["num_doc_ref2"];} 
	  if($_POST["direccion_ref2"]!=""){$direccion_ref2 = $_POST["direccion_ref2"];} 
	  if($_POST["tipo_ref2"]!=""){$tipo_ref2 = $_POST["tipo_ref2"];}
	  if($_POST["act_ref2"]!=""){$act_ref2 = $_POST["act_ref2"];}
	  if($_POST["fechaini_ref2"]!=""){$fechaini_ref2 = $_POST["fechaini_ref2"];} 
	  if($_POST["fechafin_ref2"]!=""){$fechafin_ref2 = $_POST["fechafin_ref2"];} 
	  if($_POST["retiro_ref2"]!=""){$retiro_ref2 = $_POST["retiro_ref2"];} 
	  if($_POST["telefono_ref2"]!=""){$telefono_ref2 = $_POST["telefono_ref2"];}
	  if($_POST["nprovincia"]!=""){$nprovincia = $_POST["nprovincia"];}
	  if($_POST["email"]!=""){$email = $_POST["email"];}
	  if($_POST["destacado"]!=""){$destacado = $_POST["destacado"];}
	  ?>
      ...
      <table width="685" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  if($nro_doc!="")
		  { 
		   $valido = validar_nrodoc_trabajador($nro_doc);
      ...
      <table width="685" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td height="20" colspan="2" align="left" valign="middle" class="cajatextooscuro"><strong>Provincia (*)</strong></td>
          </tr>
        <tr>
          <td height="10" align="left" valign="middle">
          ...
          <td height="10" colspan="2" align="left" valign="middle">
          <input name="nprovincia" type="text" class="cajatexto" id="nprovincia" tabindex="11" size="41" 
          maxlength="50" value="<?php if($nprovincia){echo($nprovincia);}else{echo("Provincia");}?>" 
          onfocus="if(this.value=='Provincia')this.value=''" onblur="if(this.value=='')this.value='Provincia';"/>          
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="339" height="20" align="left" valign="middle" class="cajatextooscuro">
          ...
          <td width="116" align="left" valign="middle" class="cajatextooscuro">&nbsp;</td>
      ...
      <table width="685" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <input name="telefono" type="text" class="cajatexto" id="telefono" tabindex="19" size="100" maxlength="30" 
           value="<?php echo($telefono);?>" onkeypress="return validarnumero(event)"/>          </td>
        </tr>
        <tr>
          <td height="20" align="left" valign="middle" class="cajatextooscuro">
        ...
        <tr>
          <td height="10" align="left" valign="middle">
          <input name="email" type="text" class="cajatexto" id="telefono" tabindex="20" size="100" maxlength="30" 
      ...
      <table width="685" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20" align="left" valign="middle" class="cajatextooscuro">
            <select name="tipo_estudio" class="listagris" id="tipo_estudio" tabindex="34">
              <option value="" <?php if($tipo_estudio==""){echo("selected='selected'");}?>>-</option>
        ...
        <tr>
          ...
          &nbsp;&nbsp;Destacado 
          <input name="destacado" type="checkbox" id="destacado" value="1" 
		  <?php if($destacado){echo("checked = 'checked'");}?>/>
          <br /><br />
      ...
      <div id="tab7" class="tab_content">
        ...
        <tr>
          <td align="left" valign="top" class="cajatextooscuro">
          <input name="documento6" type="file" class="cajatexto" id="documento6" tabindex="48" size="80"/>
          <br />(.doc, .pdf, .jpg)          
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left" valign="top" class="cajatextooscuro">
          <input name="documento7" type="file" class="cajatexto" id="documento7" tabindex="49" size="80"/>
          <br />(.doc, .pdf, .jpg)          
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left" valign="top" class="cajatextooscuro">
            <select name="tipo_ref1" class="listagris" id="tipo_ref1" tabindex="51">
              <option value="" <?php if($tipo_ref1==""){echo("selected='selected'");}?>>-</option>
            ...
            <select name="act_ref1" class="listagris" id="act_ref1" tabindex="52">
              <option value="" <?php if($act_ref1==""){echo("selected='selected'");}?>>-</option>
          ...
          <td align="left" valign="top" class="cajatextooscuro">
            <select name="tipo_ref2" class="listagris" id="tipo_ref2" tabindex="61">
              <option value="" <?php if($tipo_ref2==""){echo("selected='selected'");}?>>-</option>
            ...
            <select name="act_ref2" class="listagris" id="act_ref2" tabindex="62">
              <option value="" <?php if($act_ref2==""){echo("selected='selected'");}?>>-</option>
...
function validar()
{
 ...
 if(form.ape_paterno.value=="" || form.ape_materno.value=="" || form.nombres.value=="" || form.tipo_doc.value=="" 
	...
	|| form.sueldo.value=="0.00" || form.descanso.value=="" || form.nprovincia.value=="")  
 {
   ...
   if(form.nprovincia.value==""){form.nprovincia.style.backgroundColor = '#f8a5ad';} 
   return false;
 }
 else
 {
