...
$nprovincia = $_POST["nprovincia"]; 
$email = $_POST["email"]; 
$destacado = $_POST["destacado"];  

if($_FILES['documento1']['name']=="")
{
 $documento1 = $_POST["doc1"];
}
else
{
 $documento1 = $_FILES['documento1']['name'];
 ...
 $archivo_borrar = $_POST["doc1"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

if($_FILES['documento2']['name']=="")
{
 $documento2 = $_POST["doc2"];
}
else
{
 $documento2 = $_FILES['documento2']['name'];
 ...
 $archivo_borrar = $_POST["doc2"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

if($_FILES['documento3']['name']=="")
{
 $documento3 = $_POST["doc3"];
}
else
{
 $documento3 = $_FILES['documento3']['name'];
 ...
 $archivo_borrar = $_POST["doc3"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

if($_FILES['documento4']['name']=="")
{
 $documento4 = $_POST["doc4"];
}
else
{
 $documento4 = $_FILES['documento4']['name'];
 ...
 $archivo_borrar = $_POST["doc4"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

if($_FILES['documento5']['name']=="")
{
 $documento5 = $_POST["doc5"];
}
else
{
 $documento5 = $_FILES['documento5']['name'];
 ...
 $archivo_borrar = $_POST["doc5"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

if($_FILES['documento6']['name']=="")
{
 $documento6 = $_POST["doc6"];
}
else
{
 $documento6 = $_FILES['documento6']['name'];
 ...
 $archivo_borrar = $_POST["doc6"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

if($_FILES['documento7']['name']=="")
{
 $documento7 = $_POST["doc7"];
}
else
{
 $documento7 = $_FILES['documento7']['name'];
 ...
 $archivo_borrar = $_POST["doc7"];
 unlink("../../../trabajadores/".$archivo_borrar);
}

actualizar_datos_trabajador($idtrabajador, $ape_paterno, $ape_materno, $nombres, $tipo_doc, $nro_doc, $estado_civil, 
							$sexo, $instruccion, $fecha_nac, $idpais, $tipo, $nombre, $dpto, $manzana, $lote, 
							$urbanizacion, $referencia, $iddepartamento, $idprovincia, $iddistrito, $telefono, 
							$tipo_cel, $celular, $cama_afuera, $cama_adentro, $horas, $cocina, $limpieza, $ninera, 
							$enfermeria, $mayordomo, $chofer, $todo_servicio, $sueldo, $descanso, $tipo_estudio, 
							$descripcion, $empresa, $cargo, $ama_casa, $se_entero, $capacitacion1, $capacitacion2, 
							$capacitacion3, $capacitacion4, $documento1, $documento2, $documento3, $tipo_doc4, 
							$documento4, $documento5, $documento6, $documento7, $nombre_ref1, 
							$tipo_doc_ref1, $num_doc_ref1, $direccion_ref1, $tipo_ref1, $act_ref1, $fechaini_ref1, 
							$fechafin_ref1, $retiro_ref1, $telefono_ref1, $nombre_ref2, $tipo_doc_ref2, $num_doc_ref2, 
							$direccion_ref2, $tipo_ref2, $act_ref2, $fechaini_ref2, $fechafin_ref2, $retiro_ref2, 
							$telefono_ref2, $nprovincia, $email, $destacado);
