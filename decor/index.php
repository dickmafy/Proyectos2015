                ...
                <div class="fullwidthbanner">
                    <ul>
                        ...
                        <li data-transition="turnoff" data-slotamount="10" data-masterspeed="300">
                            ...
                            <img src="images/diseno/slide/header_loiste1.jpg" alt=""/>
                        ...
                        <li data-transition="papercut" data-slotamount="15" data-masterspeed="300">
                            ...
                            <img src="images/diseno/slide/header_loiste2.jpg" alt=""/>
                            <!-- THE CAPTIONS IN THIS SLDIE -->
                        ...
                        <li data-transition="turnoff" data-slotamount="10" data-masterspeed="300">
                            ...
                            <img src="images/diseno/slide/interior-design-design-coffee-table-tv-spacious-sofa-cushions-interior.jpg" alt=""/>
                            <!-- THE CAPTIONS IN THIS SLDIE -->
                        ...
                        <li data-transition="turnoff" data-slotamount="10" data-masterspeed="300">
                            <!-- THE MAIN IMAGE IN THE third SLIDE -->
                            <img src="images/diseno/slide/luppo_slide_1.jpg" alt=""/>
                            <!-- THE CAPTIONS IN THIS SLDIE -->
                            <div class="caption big_white sft stt slide3-style"
                                 data-x="150"
                                 data-y="150"
						...
						<div class="row">
							<div class="col-md-4">
								<div class="about-us-text">
									...
									<div class="innner-box">
										<p>El <b>Máster en Arquitectura y Diseño Interior</b> de Dmad es la formación óptima para quienes quieran ser polifacéticos profesionales del Interiorismo. La confianza en este completo programa formativo es tal que el alumno tiene unas <b>prácticas garantizadas o <span style="text-decoration: underline;">pre-trabajo</span> </b>en el estudio de Laura Santos, lo que le permite aplicar en proyectos reales los conocimientos adquiridos en el Máster.</p></div>
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="about-us-text">
									<h3>Texto</h3>
									<div class="innner-box">
										<p>Nuestro método docente es innovador y se basa en la enseñanza a medida y personalizada, para ello sólo admitimos a un <strong>máximo de&nbsp;diez alumnos</strong> por convocatoria.</p>
									</div>
								</div>                                
							</div>
