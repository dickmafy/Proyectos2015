...
$sorting = "&order=".$sorting_string;

// get the posts
$posts = max_query_term_posts( get_option_max('fullsize_featured_count') , get_option_max('fullsize_featured_cat'), 'gallery', $order_string, GALLERY_TAXONOMY, $sorting_string );
