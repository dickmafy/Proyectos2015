...
define( 'NOTIFIER_XML_FILE', 'http://help.doitmax.de/invictus/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier_menu() {
    ...
    add_submenu_page( 'index.php', NOTIFIER_THEME_NAME . ' Theme Updates', NOTIFIER_THEME_NAME . $new_update, 'administrator', 'theme-update-notifier', 'update_notifier' );
...
function update_notifier() {
	...
	if( ini_get('allow_url_fopen') ){
		...
		<div class="wrap">
			...
			?>
			<br />
			<div id="message" class="error below-h2"><p><strong>There is a new version of the <?php echo NOTIFIER_THEME_NAME; ?> theme available.</strong> You have version <?php echo $version; ?> installed. <strong>Please update to version <?php echo $xml->latest; ?>.</strong></p></div>
			<br />
			<?php }else{
			// No new version available
			?>
			<br />
			<div id="message" class="updated below-h2"><p><strong>Your theme is up to date.</strong> The latest version <?php echo $version; ?> of <?php echo NOTIFIER_THEME_NAME; ?> theme is installed.</strong></p></div>
			<br />
			<?php  } ?>
