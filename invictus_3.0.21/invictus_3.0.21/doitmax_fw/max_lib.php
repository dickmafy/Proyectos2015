...
function max_get_google_font() {
	...
	// create an array to store the font families for further usage
		...
		if(!in_array($family, $_temp_fonts)){
			...
			switch($family) {
				...
				default:
					...
					wp_register_style('googleFonts_'.preg_replace('/\s+/', '_', $family), '//fonts.googleapis.com/css?family='.$google_font_array[$family].$subset);
...
function max_get_google_font_html(){
	...
	$nav_font = get_option(MAX_SHORTNAME.'_font_navigation');
	$pulldown_font = get_option(MAX_SHORTNAME.'_font_navigation_pulldown');
	$fsg_title_font = get_option(MAX_SHORTNAME.'_font_fullsize_title');
	$fsg_excerpt_font = get_option(MAX_SHORTNAME.'_font_fullsize_excerpt');
	$welcome_teaser_font = get_option(MAX_SHORTNAME.'_font_welcome_teaser');
...
<style type="text/css">
	...
	#welcomeTeaser .inner strong, #sidebar .max_widget_teaser .inner strong { font-size: <?php get_option_max( 'homepage_teaser_font_size_bold', true ) ?>%; }
	<?php } ?>
	...
	#showtitle .imagecaption { color: <?php echo $fsg_excerpt_font['font_color'] ?>!important; font: <?php echo $fsg_excerpt_font['font_size'] ?>px/<?php echo $fsg_excerpt_font['line_height'] ?>px <?php echo max_get_font_string( $fsg_excerpt_font['font_family'] ) ?>!important; font-weight: <?php echo $fsg_excerpt_font['font_weight']  ?> !important; }
	<?php } ?>
