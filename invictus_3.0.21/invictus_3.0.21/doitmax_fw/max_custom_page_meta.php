...
function max_add_page_meta() {
	...
	if ( $p_tpl == "template-sortable.php") {
		...
		// Columns
		$obj_gallery->addDropdown(array(
			"id" => MAX_SHORTNAME."_page_sortable_columns",
			"options" => array('one'=>'1 Column','two'=>'2 Columns', 'three'=>'3 Columns', 'four'=>'4 Columns'),
			"standard" => 'three',
			"label" => __('Sortable columns', MAX_SHORTNAME),
			"desc" => 'Choose, how to show the images aspect ratio in this sortable template.',
		));

		// Image aspect ratio
		$obj_gallery->addDropdown(array(
			"id" => MAX_SHORTNAME."_page_sortable_aspect_ratio",
			"options" => array('default'=>'Default 4:3','squared'=>'Squared', 'portrait'=>'Portrait', ),
			"standard" => 'default',
			"label" => __('Image aspect ratio', MAX_SHORTNAME),
			"desc" => 'Choose, how to show the images aspect ratio in this sortable template.',
		));
		...
		$obj_gallery->addDropdown(array(
			...
			"display" => true,
			"desc" => 'Choose, if you want to show the choosen gallery content in full browser width.',
		));
