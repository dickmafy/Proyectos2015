		...
		$this->addGroupOpen(array(
  		...
  		$std_max_show_page_fullsize_type = !empty($default_background) ? $default_background : "single";
			...
			$this->addDropdown(array(
				...
				"options"   => array("single" => __('Single Image', MAX_SHORTNAME), "slideshow" => __('Slideshow from Gallery', MAX_SHORTNAME), 'default' => __('Default Theme Option', MAX_SHORTNAME)),
				"standard"  => $std_max_show_page_fullsize_type,
				"desc"      => __('Do you want to show a single image or a slideshow from the gallery the photo is attached to for your background on this page. If this set to "Default Theme Option", you have to set the default type at the "Blog" tab of your Invictus theme settings.', MAX_SHORTNAME )
			));
