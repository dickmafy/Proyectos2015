...
<?php if ( !post_password_required() ) { ?>
	<?php $show_fullsize_title = $meta['max_show_page_fullsize_title']; ?>
		...
		<div id="sidebar" class="fullsize-sidebar">
		  <?php
		  wp_reset_query();
      /* Widgetised Area */	if ( !function_exists( 'dynamic_sidebar' ) || !dynamic_sidebar( max_get_custom_sidebar('sidebar-fullsize-video')) );
      ?>
		</div>
		<?php endif; ?>
      ...
      <?php the_content() ?>
			...
			<div id="showtitle" class="clearfix">
				 <div class="title"><span class="imagetitle"><a href="#"><?php the_title() ?></a></span></div>
			</div>
