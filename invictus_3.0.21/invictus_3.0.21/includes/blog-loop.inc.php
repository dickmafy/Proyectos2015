              ...
              $img_w = $page_tpl == 'template-blog-fullsize.php' ? MAX_FULL_WIDTH : MAX_CONTENT_WIDTH;
							...
							<div class="entry-image">
								<a href="<?php the_permalink() ?>" title="<?php echo htmlspecialchars(get_the_excerpt()) ?>">
									<img src="<?php echo $imgUrl ?>" width="<?php echo $img_w ?>" class="fade-image<?php if( get_option_max('image_show_fade') != "true") { echo(" no-hover"); } ?>" alt="<?php the_title() ?>" title="<?php echo htmlspecialchars(get_the_excerpt()) ?>" />
								</a>
							</div>
					...
					<div class="clearfix">
						...
						if( get_option_max('general_show_fullblog') == 'true'){
							the_content(__( 'Continue Reading...', MAX_SHORTNAME ), FALSE);
						}else{
							the_excerpt();
						}
						?>
					...
					<footer>
						...
						if( get_option_max('general_show_fullblog') != 'true'){
						?>
						<p class="read-more"><a href="<?php the_permalink() ?>" title="<?php echo __( 'Continue Reading...', MAX_SHORTNAME ) ?>" class="more-link"><?php echo __( 'Continue Reading...', MAX_SHORTNAME ) ?></a></p>
						<?php } ?>
					</footer><!-- .entry-meta -->
