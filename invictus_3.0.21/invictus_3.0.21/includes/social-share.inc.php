<?php
		...
		<div class="clearfix entry-share">
			...
			<div class="share-button share-twitter">
				...
				<a href="http://twitter.com/share?url=<?php echo get_permalink($post->ID) ?>&amp;text=<?php echo get_the_title() ?> | <?php echo get_bloginfo( 'name' ); ?>" class="twitter-share-button" data-lang="en" data-url="<?php echo get_permalink($post->ID) ?>">Tweet</a>
			</div>
			<?php } ?>			
