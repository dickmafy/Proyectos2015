...
public class SiprePlanillaDetallePK implements Serializable {
    ...
    public String toString() {
        return "net.codejava.spring.model.SiprePlanillaDetallePK[ ctpCodigo=" + ctpCodigo + ", cciCodigo=" + cciCodigo + ", cpersonaNroAdm=" + cpersonaNroAdm + ", cplanillaMesProceso=" + cplanillaMesProceso + ", nplanillaNumProceso=" + nplanillaNumProceso + " ]";
    }
