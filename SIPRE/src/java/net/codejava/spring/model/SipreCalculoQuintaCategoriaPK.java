 ...
 */
@Embeddable
public class SipreCalculoQuintaCategoriaPK implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SipreCalculoQuintaCategoriaPK)) {
            return false;
        }
        SipreCalculoQuintaCategoriaPK other = (SipreCalculoQuintaCategoriaPK) object;
    ...
    public String toString() {
        return "net.codejava.spring.model.SipreCalculoQuintaCategoriaPK[ cpersonaNroAdm=" + cpersonaNroAdm + ", cplanillaMesProceso=" + cplanillaMesProceso + ", nplanillaNumProceso=" + nplanillaNumProceso + " ]";
    }
