                ...
                <h:panelGroup rendered="#{variable.pagingInfo.itemCount > 0}">
                    ...
                    <h:dataTable value="#{variable.variableItems}" var="item" border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px">
                        <h:column>
                            ...
                            <h:outputText value="#{item.pkVariable}"/>
                        </h:column>
                        <h:column>
                            <f:facet name="header">
                        ...
                        <h:column>
                            ...
                            <h:commandLink value="Show" action="#{variable.detailSetup}">
                                <f:param name="jsfcrud.currentVariable" value="#{jsfcrud_class['net.codejava.spring.model.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][item][variable.converter].jsfcrud_invoke}"/>
                            </h:commandLink>
                            <h:outputText value=" "/>
                            ...
                            <h:outputText value=" "/>
                            <h:commandLink value="Destroy" action="#{variable.remove}">
                                <f:param name="jsfcrud.currentVariable" value="#{jsfcrud_class['net.codejava.spring.model.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][item][variable.converter].jsfcrud_invoke}"/>
                            </h:commandLink>
                        </h:column>
