...
<!-- saved from url=(0054)http://www.chrisbarrettdesign.com/projects/Residential -->
...
<link rel="canonical" href="http://www.chrisbarrettdesign.com/projects"><link rel="shortcut icon" href="http://www.chrisbarrettdesign.com/favicon.ico">
...
<link rel="stylesheet" type="text/css" href="./residencial_files/stylesheet.php">
...
<script type="text/javascript" async="" src="./residencial_files/ga.js"></script><script type="text/javascript" src="./residencial_files/jsapi"></script>
	<script type="text/javascript">
		google.load("jquery", "1.4.2");
		google.load("jqueryui", "1.8.4");
	</script><script src="./residencial_files/jquery.min.js" type="text/javascript"></script><script src="./residencial_files/jquery-ui.min.js" type="text/javascript"></script>
<script type="text/javascript" src="./residencial_files/easing.js"></script>
<script type="text/javascript" src="./residencial_files/vgrid.js"></script>

<script type="text/javascript" src="./residencial_files/usy3mzm.js"></script>
...
<li><a href="http://www.chrisbarrettdesign.com/contact"><span>CONTACT</span></a>
		...
		<div id="main">
	<script type="text/javascript" src="./residencial_files/prototype.js"></script>
    <script type="text/javascript" src="./residencial_files/scriptaculous.js"></script>
	<script type="text/javascript" src="./residencial_files/effects.js"></script>
    
    <script type="text/javascript" src="./residencial_files/carousel.js"></script>
<style>
...
<link rel="stylesheet" type="text/css" href="./residencial_files/galleria.fullscreen.css">
<div class="gal_menu">
		<a href="./residencial_files/residencial.html" class="current">Residential</a>
		<a href="http://www.chrisbarrettdesign.com/projects/Commercial">Commercial</a>
		<a href="http://www.chrisbarrettdesign.com/projects">All</a>
	<div style="float:right;padding-right: 15px;line-height: 20px;">PROJECT TYPE: </div>
</div>
<div class="clear"></div>
	<div id="projects_list" style="position: relative; width: 980px; overflow: hidden; height: 928px; display: block;">
					...
					<a href="http://www.chrisbarrettdesign.com/project/12th-street" class="img">
						...
						<img src="./residencial_files/290_small.jpg" alt="">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/mulholland-drive" class="img">
						...
						<img src="./residencial_files/304_small.jpg" alt="">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/wellesley-avenue" class="img">
						...
						<img src="./residencial_files/263_small.jpg" alt="">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/mi-sueno" class="img">
						...
						<img src="./residencial_files/230_small.jpg" alt="">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/6th-street" class="img">
						...
						<img src="./residencial_files/265_small.jpg" alt="">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/aderno-street" class="img">
						...
						<img src="./residencial_files/232_small.jpg" alt="" style="opacity: 0.770112;">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/palisades-beach-road" class="img">
						...
						<img src="./residencial_files/104_small.jpg" alt="">
					</a>
					...
					<a href="http://www.chrisbarrettdesign.com/project/san-onofre-drive" class="img">
						...
						<img src="./residencial_files/21_small.jpg" alt="">
					</a>
					<span style="padding-left: 17px;">SAN ONOFRE DRIVE</span>
				</div>
						<div class="gal" id="40" style="margin: 0px 0px 40px 5px; position: absolute; left: 0px; top: 464px;">
	...
	<div id="social">
		...
		<link href="./residencial_files/slim-081711.css" rel="stylesheet" type="text/css">
		...
		<div style="float: right;">
			<a style="float: left; padding-left:5px;" href="http://www.facebook.com/pages/Chris-Barrett-Design/106822119366139" target="_blank"> <img src="./residencial_files/fb.jpg" alt="facebook"> </a> 
			<a style="float: left; padding-left:5px;" href="http://twitter.com/#!/cbarrettdesign" target="_blank"> <img src="./residencial_files/tw.jpg" alt="twitter"> </a>
			<a style="float: left; padding-left:5px;" href="http://instagram.com/chrisbarrettdesign" target="_blank"> <img src="./residencial_files/instagram.jpg" alt="instagram"> </a> 
			<a style="float: left; padding-left:5px;" href="http://pinterest.com/cbarrettdesign/" target="_blank"> <img src="./residencial_files/pinterest.jpg" alt="pinterest"> </a>
			<a style="float: left; padding-left:5px;" href="http://www.houzz.com/pro/chrisbarrett/chris-barrett-design" target="_blank"> <img src="./residencial_files/houzz.jpg" alt="houzz"> </a>
		</div>
	</div>
